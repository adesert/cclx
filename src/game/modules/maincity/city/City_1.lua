...
local City_1 = class("City_1",require("game.base.BaseLayer"))

function City_1:ctor(id)
    self.m_id = id
    self.m_data = nil
	self.super.ctor(self)
end

function City_1:_overrideInit()
	self:_init()
	self:_initdata()
    self:_initCreatures()
end

function City_1:_init()
...
function City_1:_initCreatures()
    ...
    local p =  global.objMgr:createCreatureByProto("10_5",self.creature_layer)
    p:setPosition(center_x+220,200)
    
    p =  global.objMgr:createCreatureByProto("10_6",self.creature_layer)
    p:setPosition(center_x+320,300-20)
end

function City_1:_initdata()

end

function City_1:handle()
	
end

function City_1:updateDir(dir,moveDir,actionName)
--    local vx = self:getPositionX()
--    
--    local d = 5
--    if dir == DIRECTION.RIGHT then
--        vx = vx-d
--        if vx + self.m_w >=define_right then
...
function City_1:updateDirEnd(dir,moveDir,actionName)
    print(dir,moveDir,actionName)
    self:_changePlayerDir(dir,moveDir,actionName)
    self:checkCollsionPlayer()
end

function City_1:_changePlayerDir(dir,moveDir,actionName)
...
function City_1:checkCollsionPlayer()
